...
window.SAMPLE_POSTS = [
  ...
  */
  {
    slug: "data-backup",
    title: "消えたデータは戻らない。でも、消えない置き方がある",
    category: "ITの基礎",
    date: "2026.06.30",
    readMin: 4,
    image: "assets/images/data-backup-eyecatch.png?v=1",
    excerpt: "昨日2時間かけて作った資料が、保存する前にパソコンが落ちて消えた——そんな経験はないでしょうか。こまめな保存も、USBへのコピーも、自分の手でやっている作業です。集中していると、つい忘れる。クラウドにしておくと、打ち込んだそばから自動で残るので、その手間も「とり忘れ」もいらなくなります。まず、消えたら困るデータはどれかを書き出すところからの話です。",
    tags: ["ITの基礎", "バックアップ"],
  },
  {
    slug: "what-is-cloud",
