      ...
      <article style={{ padding: "16px 0 80px" }}>
        <div className="container-narrow fade-up privacy-body" style={{ fontSize: 16, lineHeight: 2, color: "var(--ink-900)" }}>
          ...
          <ul>
            ...
            <li>Contabo（サーバーホスティング）</li>
            <li>LINE公式アカウント（お客様との連絡）</li>
            <li>Cloudflare（サーバーホスティング・データ保管）</li>
            <li>Notion（業務情報・案件記録の管理）</li>
            <li>GitHub（ソースコードの管理・ウェブサイトの公開）</li>
            <li>その他、業務連絡、日程調整、契約、請求、サービス提供に必要なクラウドサービス</li>
          </ul>
          <p>当社ウェブサイトには、個人情報を直接送信する入力フォームは設置していません。お問い合わせは、無料相談のご予約（TimeRex）、メール、または公式LINEにて承っています。</p>

          <h2>6. 外国にある事業者の利用について</h2>
          <p>当社は、業務データの処理にあたり、米国のAIサービス事業者（OpenAI, L.L.C.／Anthropic, PBC）、ドイツに所在するサーバー事業者（Contabo GmbH）、および米国に所在するクラウド事業者（Cloudflare, Inc.／Notion Labs, Inc.／GitHub, Inc.）のサービスを利用しています。</p>
          <p>AIサービス事業者については、お預かりしたデータがAIモデルの学習に利用されない契約形態・設定を選択しています（API利用についてはデータ処理契約を締結）。いずれの事業者についても、各国の個人情報保護制度を把握した上で、適切な安全管理措置を講じています。</p>
