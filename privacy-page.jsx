    ...
    <div className="page" style={{ background: "var(--paper)" }}>
      ...
      <article style={{ padding: "16px 0 80px" }}>
        <div className="container-narrow fade-up privacy-body" style={{ fontSize: 16, lineHeight: 2, color: "var(--ink-900)" }}>
          ...
          <p>当社は、業務データの処理にあたり、米国のAIサービス事業者（OpenAI, L.L.C.／Anthropic, PBC）およびドイツに所在するサーバー事業者（Contabo GmbH）のサービスを利用しています。</p>
          <p>これらの事業者については、お預かりしたデータがAIモデルの学習に利用されない契約形態・設定を選択し（API利用についてはデータ処理契約を締結）、各国の個人情報保護制度を把握した上で、適切な安全管理措置を講じています。</p>
          ...
          <p style={{ marginTop: 48, fontSize: 14, color: "var(--ink-500)" }}>
            制定日：2026年3月4日<br/>最終改定日：2026年7月5日<br/>株式会社BitVoyage
          </p>
        </div>
      </article>
