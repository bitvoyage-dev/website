...
function ServiceSteps() {
  const steps = [
    ...
    { n: "2", t: "手作業をなくす仕組みづくり", feeling: "「今月もこれをやらなきゃ」が、見て確認するだけに変わります。", sub: "先に「こうなったら楽になる」形を決めて、そこへ段階的に進めます", price: "20万円〜50万円", href: "service.html#core" },
    { n: "3", t: "業務に合わせた個別構築", feeling: "休む人がいても業務が止まらない。そこまで整えます。", sub: "人に頼りきりの業務を、任せやすく続けられる形に整えます", price: "50万円〜／個別見積り", href: "service.html#custom" },
    ...
    <section className="section" style={{ paddingTop: 60, paddingBottom: 80 }}>
      <div className="container-narrow fade-up">
        ...
        <p style={{ textAlign: "center", fontSize: 12, color: "var(--ink-500)", margin: "14px 0 0" }}>
          ※ 表示価格はすべて税別・目安です。段階に分けて進められるので、はじめから全額を決める必要はありません。
        </p>
