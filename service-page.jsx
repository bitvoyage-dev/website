...
function ServicePage() {
  ...
  const details = [
    {
      ...
      price: "無料",
      priceNote: "オンライン／対面どちらも可（対面は広島市・東広島市・呉市内は無料、市外は交通費のみ）。何を頼めばいいか決まっていなくて大丈夫です。",
      illustration: "assets/illustrations/01-person-thinking.png",
      description: [
        "毎月くり返している手作業や、売上につながらないのに時間を取っている作業を、一緒に確認します。",
        "まずは「どこに時間を取られているか」「何から減らせそうか」を整理するところから始めます。",
      ],
      sections: [
    ...
    },
    {
      ...
      sections: [
        ...
        { kind: "note", text: "3万円〜は、まず1つの作業に絞って小さく始めるときの目安です。作業範囲・利用環境・データの扱い方で金額は変わるので、内容を確認して事前にお見積りをお渡しします。" },
    ...
    },
    {
      ...
      description: [
        ...
        "後日、減らせる作業の候補と、次に何から始めるとよいかをお伝えします。",
      ],
      sections: [
    ...
    },
    {
      ...
      description: [
        ...
        "本格的に作りたいものが出てきても、対応できます。要件を確認し、設計・検証まで含めて別途お見積りします。継続サポートは、その入口にもなります。",
      ],
      sections: [
        ...
        { kind: "list", label: "継続サポートに含む軽微作業（月2時間まで）", variant: "dot", items: [
          "Excel・スプレッドシートの軽い修正",
          "項目追加",
          "簡単な関数修正",
          "管理表の整理",
  ...
  const cases = [
    ...
    },
    {
      ...
      problem: "必要な情報を探すのに時間がかかり、毎回資料や過去情報を確認していた",
      result: <>質問すると必要な情報にたどり着ける形にして、<span className="marker">探す・確認する時間を削減</span></>,
    },
  ];
      ...
      <section className="page-hero service-hero">
        <div className="container-narrow fade-up" style={{ textAlign: "center" }}>
          ...
          <h1 className="page-hero-title">
            小さく始めて、継続して<span className="underline-hand">減らす</span>。
          </h1>
      ...
      <section className="section" style={{ padding: "80px 0" }}>
        <div className="container-narrow fade-up">
          ...
          {[
            ...
            { q: "②小さな作業をひとつ減らすと④継続して減らすサポートは、何が違うのですか？", a: "②は「この作業を減らしてほしい」という1件単位の依頼です。④は、毎月一緒に「次に減らせる作業」を決めて進める継続サポートで、改善が後回しにならないように外部から伴走します。" },
            { q: "③現場を見て整理すると、何がもらえるのですか？", a: "2〜3時間の現場確認です。実際の作業や情報の流れを見せていただき、「時間を取られている作業」「減らせそうな作業（3〜5個ほど）」「次に着手しやすい改善案」を整理してお伝えします。次に減らす作業を1つ決めるための時間です。" },
            ...
            { q: "対応エリアはどこまでですか？", a: "作業見直し相談は、オンラインなら全国対応。対面は広島市・東広島市・呉市内なら無料で、市外は交通費のみご負担ください。③現場を見て整理するなど現場確認を含むものは、広島県内を中心に現場訪問で対応しています（県外は要相談・出張可・交通費別）。" },
          ].map((f, i) => (
