...
function ServicePage() {
  ...
  const details = [
    ...
    },
    {
      ...
      price: "20万円〜50万円",
      priceNote: "まず作る一段目の目安です。使ってみて効果を確かめてから次に進むので、はじめから全体の金額を決める必要はありません。段を重ねれば合計は大きくなりますが、そのつどお見積りしてからの着手です。",
    ...
    },
    {
      ...
      price: "月15万円〜",
      priceNote: "月4回（1回2〜3時間）の打ち合わせが標準です。オンラインでも、ご訪問でも対応します。回数を減らしたい場合はご相談ください。",
      ...
      description: [
        ...
        "打ち合わせの時間内でできる手直しは、その場で一緒に対応します。ただ、その場の手直しだけで業務の流れごと変わることは、あまりありません。整理が進むと、たいていは仕組みそのものを作り直す話になります。そこは別にお見積りしますが、流れの整理と設計は毎月の中で済んでいるので、実装ぶんだけの費用になります。",
      ],
      sections: [
        { kind: "callout", label: "仕組みづくりの費用が、実装ぶんだけになります", lines: [
          "顧問を続けていくと、どこかで必ず「この作業は仕組みごと変えないと楽にならない」という話になります。そこは別にお見積りしますが、顧問で入っている場合は実装ぶんだけの費用です。",
          "単発でご依頼いただく場合は、現場を見て業務の流れを整理し、どう作るかを決めるところから始まるので、その分も費用に入ります。顧問では毎月それを一緒にやっているので、あらためていただく必要がありません。",
        ] },
        ...
        { kind: "note", text: "顧問料の中に実装まで含めないのは、どこまで対応するのかの線が引けなくなるためです。次に手をつけるところを決める役と、実際に作る役を分けておく形にしています。" },
      ],
    },
    {
      id: "maintain",
      ...
      <section className="section" style={{ padding: "56px 0" }}>
        <div className="container-narrow fade-up">
          ...
          {[
            ...
            { q: "「伴走顧問」と「保守サポート」は何が違いますか？", a: "役割がまったく別です。保守サポート（月3万円〜）は、お作りした仕組みがこれからも動き続けるようにお預かりするもので、不具合対応やGoogle側の仕様変更への追随が中心です。伴走顧問（月15万円〜）は、毎月の打ち合わせで現場の状況を確認し、次にどこへ手をつけるかを決め続ける役割です。「壊れないようにしておきたい」なら保守、「改善を止めずに前へ進めたい」なら顧問、という選び方になります。" },
            { q: "伴走顧問で、実装もしてもらえますか？", a: "打ち合わせの時間内でできる手直しは、その場で一緒に対応します。項目を足す、集計を直す、といった細かいものはここに含まれます。ただ、続けていくとどこかで必ず「この作業は仕組みごと変えないと楽にならない」という話になります。局所的な手直しだけで業務の流れが変わることは、あまりないためです。その部分は別にお見積りしますが、顧問で入っている場合は実装ぶんだけの費用になります。顧問は次に手をつけるところを決める役、仕組みづくりは実際に作る役、と分けています。" },
            { q: "顧問なしで仕組みづくりを頼む場合と、費用は変わりますか？", a: "変わります。単発でご依頼いただく場合は、現場を見て業務の流れを整理し、どう作るかを決めるところから始まるので、その分も費用に入ります（一段目で20万円〜50万円が目安です）。伴走顧問で入っている場合は、その整理と設計を毎月の打ち合わせで一緒にやっているので、あらためていただく必要がありません。実装ぶんだけのお見積りになります。" },
