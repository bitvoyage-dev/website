      ...
      <section className="section" style={{ padding: "56px 0" }}>
        <div className="container-narrow fade-up">
          ...
          {[
            ...
            { q: "顧問なしで仕組みづくりを頼む場合と、費用は変わりますか？", a: "変わります。単発でご依頼いただく場合は、現場を見て業務の流れを整理し、どう作るかを決めるところから始まるので、その分も費用に入ります（20万円〜50万円が中心です）。伴走顧問で入っている場合は、その整理と設計を毎月の打ち合わせで一緒にやっているので、あらためていただく必要がありません。実装ぶんだけのお見積りになります。" },
