  ...
  const details = [
    ...
    },
    {
      ...
      description: [
        ...
        "打ち合わせの時間内でできる手直しは、その場で一緒に対応します。ただ、その場の手直しだけで業務の流れごと変わることは、あまりありません。整理が進むと、たいていは仕組みそのものを作り直す話になります。そこは「手作業をなくす仕組みづくり」として、別にお見積りします。",
      ],
      sections: [
        ...
        { kind: "note", text: "顧問を続けていくと、どこかで必ず「この作業は仕組みごと変えないと楽にならない」という話になります。そこは「手作業をなくす仕組みづくり」（20万円〜50万円）として、別にお見積りします。顧問料の中に実装まで含めると、どこまで対応するのかの線が引けなくなるためです。次に手をつけるところを決める役と、実際に作る役を分けておく形です。" },
      ],
    },
    {
      id: "maintain",
      ...
      <section className="section" style={{ padding: "56px 0" }}>
        <div className="container-narrow fade-up">
          ...
          {[
            ...
            { q: "伴走顧問で、実装もしてもらえますか？", a: "打ち合わせの時間内でできる手直しは、その場で一緒に対応します。項目を足す、集計を直す、といった細かいものはここに含まれます。ただ、続けていくとどこかで必ず「この作業は仕組みごと変えないと楽にならない」という話になります。局所的な手直しだけで業務の流れが変わることは、あまりないためです。その部分は「手作業をなくす仕組みづくり」（20万円〜50万円）として、別にお見積りします。顧問は次に手をつけるところを決める役、仕組みづくりは実際に作る役、と分けています。" },
