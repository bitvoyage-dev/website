...
function ArticleBody_DataBackup() {
  return (
    <>
      <p>昨日2時間かけて作った資料が、保存する前にパソコンが落ちて、消えました。</p>
      <p>Excelのマクロを作っていた頃、私はこれを何度もやりました。あんなに時間をかけたのに、また一からやり直し。</p>
      <p>こういうの、クラウドにしておくと起きないんですよね。今日は、その話です。</p>

      <h2 style={H2_STYLE}>「保存」も、手でやっている作業のひとつ</h2>
      <p>こまめにボタンを押して保存する。ふだん意識しませんが、これも自分の手でやっている作業です。</p>
      <p>作業に集中していると、つい忘れます。</p>

      <h2 style={H2_STYLE}>そして、消えるときは、消える</h2>
      <p>私の場合は、マクロ作りに夢中になっていて、保存する前に画面が固まりました。さっきまでの作業は、どこにもありません。</p>
      <p>保存してあっても、安心とは限りません。パソコンそのものが、ある日動かなくなる。中のファイルごと、消えます。</p>
      <blockquote style={QUOTE_STYLE}>
        <p style={QUOTE_P_STYLE}>「うちは、ときどきUSBにもコピーしてるから大丈夫」</p>
      </blockquote>
      <p>そう思っていても、最後にコピーをとったのは、いつでしょうか。そのUSBも、壊れます。</p>
      <p><span className="marker">惜しいのは、また同じ時間をかけ直すことです</span>。</p>
      <p>図面や点検記録、何年分もの日報。作るのに時間がかかったものほど、もったいない。</p>

      <h2 style={H2_STYLE}>クラウドにすると、保存を勝手にやってくれる</h2>
      <p>ここからが、いいところです。</p>
      <p>ネット上にファイルを置いておくと、打ち込んだそばから、自動で残ります。作りかけも、控えも。</p>
      <p>手でボタンを押す保存も、USBへのコピーも、「とり忘れ」も、いらなくなります。</p>
      <p>スマホの写真と同じです。機種を変えても前の写真が残っているのは、勝手に控えがとられているから。あれを、仕事のファイルでもやる、ということです。</p>

      <h2 style={H2_STYLE}>まず、消えたら困るものを挙げてみる</h2>
      <p>とはいえ、全部をいきなりクラウドにしなくて大丈夫です。</p>
      <p>先にやるのは、消えたら本当に困るデータはどれかを、書き出すことです。</p>
      <div style={LIST_BOX_STYLE}>
        <ul style={{ margin: 0, paddingLeft: 20 }}>
          <li>それは今、何台のパソコン・USBに入っているか</li>
          <li>そのうち1つが壊れたら、戻せるか</li>
          <li>最後に控えをとったのは、いつか</li>
        </ul>
      </div>
      <p>挙げてみると、本当に守りたいものは、思ったより絞れます。そこから、手をかけずに残る形にしていけば十分です。</p>
      ...
      <div style={NOTE_BOX_STYLE}>
        ...
        <p style={{ margin: "0 0 12px" }}>
          大がかりな仕組みを入れるのではなく、いまの環境のまま、手をかけなくても控えが残る形に整えます。
        </p>
        <p style={{ margin: 0 }}>
          東広島・呉を中心に、売上につながらない作業を減らし、会社が前に進む余力を一緒につくります。
        </p>
